...
#as we have cleared the dataset, the next task is to have a look at the Wordcloud. A Wordcloud represents the most numbers of words larger and vice versa:
...
#I will convert these words into categorical values:
...
print(X_train.shape)
print(X_test.shape)
#let’s train the model and print the classification report:
